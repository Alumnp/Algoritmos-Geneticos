...
public class Genetico_SAT {
    ...
    public void evolucionar() {
        ...
        Individuo_SAT mejor
                = Herramientas.Herramientas.mejorPoblacionSB(poblacionActual);
        ...
        for (int g = 1; g < this.numGeneraciones; g++) {
            ...
            for (int i = 0; i < this.tamanoPob; i++) {
                ...
                Individuo_SAT madre
                        = Herramientas.Herramientas.seleccionAleatoriaSB(
                                this.getPoblacionActual());
                // Seleccion de un padre
                Individuo_SAT padre
                        = Herramientas.Herramientas.seleccionAleatoriaSB(
                                this.getPoblacionActual());
                // cruza (Retornar el mejor ind de la cruza)
                Individuo_SAT hijo = Cruza_SAT.cruzaPorMascaraBinaria(madre,
                        padre);
        ...
        Grafica grafica = new Grafica("Generacion", "Fitness",
                "Algoritmo Genetico");
    ...
    private void generarPoblacionInicial() {
        ...
        for (int i = 0; i < this.tamanoPob; i++) {
            this.getPoblacionActual().add(new Individuo_SAT(dt.getList(),
                    dt.getTamArray(), dt.getNumPos(), dt.getNumVar()));
        }
    }
