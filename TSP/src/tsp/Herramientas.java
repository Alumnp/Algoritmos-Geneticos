...
//            NUMERO DE CIUDADES
            wr.println("Numero de ciudades: "+GeneradorInstanciasTSP.INSTANCIAS.length);
            
//            CIUDAD INICIAL
            wr.println("Ciudad Inicial: "+mejor.getGenotipo()[0]);
            
//            FITNESS
            wr.println("Fitness: "+mejor.getFitness());
