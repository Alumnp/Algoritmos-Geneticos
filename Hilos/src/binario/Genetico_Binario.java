 ...
 * @author vazqu
 */
public class Genetico_Binario {

    private int tamanoPob;
    private int numGeneraciones;
    private double probMuta;
    private int bits;
    private ArrayList<Individuo_Binario> poblacionActual;

    public Genetico_Binario(int tamanoPob, int numGeneraciones, double probMuta, int bits) {
    ...
    private void generarPoblacionInicial() {
        ...
        for (int i = 0; i < this.tamanoPob; i++) {
            this.getPoblacionActual().add(new Individuo_Binario(this.bits));
        }
