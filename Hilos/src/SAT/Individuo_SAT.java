...
public class Individuo_SAT {
    ...
    public Individuo_SAT(int[][] genotipo, int tamArray, int numPosi, int numVariables) {
    ...
    public Individuo_SAT(int[][] genotipo, boolean[] fenotipo, int numPosi, int numVariables) {
        this.genotipo = genotipo;
